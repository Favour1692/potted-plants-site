...
import Banner from "./Images/Products/Banner.webp";
    ...
    <div className="mt-[10vh]">
      ...
      <div className="container">
        <p className="py-2" data-aos="fade-down" data-aos-delay="200">
          We provide a variety of plants for different purposes and settings,
          including indoor, outdoor, air purifying plants and plant gifts. Our
          plants are grown naturally and with love.
        </p>
        <div className="bg-[#272319] py-8 px-4 my-4 rounded-2xl text-secondary">
          <div>
            <h3
              className="text-4xl text-white font-semibold font-subheadings"
              data-aos="fade-right"
            >
