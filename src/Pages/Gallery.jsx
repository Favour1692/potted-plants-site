    ...
    <div className="mt-[10vh]">
      <div className="container">
        <p className="text-center py-4" data-aos="fade-down">
          Explore our gallery and see how potted plants can bring life, warmth, and freshness to any space. From cozy homes to stylish offices, our plants add a natural touch that enhances every environment. Get inspired by these beautiful
          arrangements and imagine the possibilities for your own space!
        </p>
        <div className="w-[90%] mx-auto grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 xl:grid-cols-4 gap-8 pb-12 pt-4" data-aos="fade-left">
          <div className="flex flex-col items-center w-full overflow-hidden shadow-md shadow-thick py-4" data-aos="flip-up" data-aos-delay="100">
          ...
          <div className="flex flex-col items-center w-full overflow-hidden shadow-md shadow-thick py-4" data-aos="flip-up">
